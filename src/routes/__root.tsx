    ...
    <div className="page-aurora flex min-h-screen items-center justify-center px-4">
      <div className="glass max-w-md rounded-2xl p-8 text-center">
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="gradient-brand inline-flex items-center justify-center rounded-md px-4 py-2 text-sm font-medium text-primary-foreground transition-opacity hover:opacity-90"
          >
            Go home
          </Link>
        </div>
  ...
  head: () => ({
    meta: [
      ...
      { title: "AI Productivity Assistant" },
      {
        name: "description",
        content:
          "Draft emails, summarize meetings, plan your day and research topics with one AI workspace.",
      },
